...
const STDLIBS_BY_VERSION = [
    ...
    v"1.13.0" => Dict{UUID,StdlibInfo}(
        ...
        UUID("29816b5a-b9ab-546f-933c-edad1886dfa8") => StdlibInfo(
            ...
            UUID("29816b5a-b9ab-546f-933c-edad1886dfa8"),
            v"1.11.3+1",
            UUID[UUID("458c3c95-2e84-50aa-8efc-19380b2a3a95"), UUID("56f22d72-fd6d-98f1-02f0-08ddc0907c33"), UUID("83775a58-1f1d-513f-b197-d71354ab007a"), UUID("8f399da3-3557-5675-b5ff-fb832c97cbdb")],
            UUID[],
        ),
        UUID("183b4373-6708-53ba-ad28-60e28bb38547") => StdlibInfo(
            "LibUV_jll",
